      ...
      <?php 
        ...
        if ($consulta->num_rows > 0) {
          ...
          while ($row = $consulta->fetch_assoc()) {
              ...
              echo "<tr><td scope='row'><a href='fichaProducto.php?id=$id'><img src='$img' class='img-fluid' width=350px><link></td><td><br><div class='h2'>$nombre</div>Precio:$  <b>$prec</b><p class=secudary>$des</p></td></tr>";
          }
