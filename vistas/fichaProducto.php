...
.custom-card {
  ...
  <!--Ficha de producto(TABLA) --> 
  <div class="container">
    <div class="row">
      <div class="col-md-12">
      <table class="table table-light border-top-0 rounded vh-100">
     <thead>
       <tr>
       <th scope="col"></th>
       <th scope="col"></th>
  ...
  <!-- Inicio del PHP que trae toda la info de los productos -->
      <?php 
        ...
        $consulta = $conn->query("SELECT * FROM producto WHERE id='$id'");
        ...
        if ($consulta->num_rows > 0) {
          ...
          while ($row = $consulta->fetch_assoc()) {
              ...
              echo "<tr><td scope='row'><br><br><img src='$img' class='img-fluid' width=600px></td><td><br><div class='h2'>$nombre</div>Precio:$  <b>$prec</b><p class=secondary>$des</p></td></tr>";
          }
